...
public class CreateModel {
	...
	public static void main(String[] args) throws Exception {
	     ...
	     */
	    File sentences = new File("../models/"+modelType+"/sentences.txt");

	    /**
	     * establish a file to put your NER hits in (the ones you want to keep based on prob)
	     */
	    File knownEntities = new File("../models/"+modelType+"/knownentities.txt");

	    /**
	     * establish a BLACKLIST file to put your bad NER hits in (also can be based on prob)
	     */
	    File blacklistedentities = new File("../models/"+modelType+"/blentities.txt");

	    /**
	     * establish a file to write your annotated sentences to
	     */
	    File annotatedSentences = new File("../models/"+modelType+"/annotatedSentences.txt");

	    /**
	     * establish a file to write your model to
	     */
	    File theModel = new File("../models/"+modelType+"/itq-"+modelType+"-model.bin");
	     ...
	     */
	    DefaultModelBuilderUtil.generateModel(sentences, knownEntities, blacklistedentities, theModel, annotatedSentences, modelType, 10);
	}
}
